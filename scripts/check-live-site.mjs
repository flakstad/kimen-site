...
const pages = [
  ...
  ["/guides/", "Start with the problem."],
  ["/guides/coding-agents-and-local-secrets/", "Coding agents can read more than code."],
  ["/docs/vaults-secrets-and-sessions/", "Expect a passphrase prompt for every invocation."],
  ["/docs/profiles-and-runtime-projection/", "One profile. Four ways to supply a runtime."],
  ["/guides/kimen-vs-1password-and-cloud-secret-managers/", "Should you use Kimen, 1Password or a cloud secret manager?"],
  ...
  ["/guides/keep-development-secrets-out-of-git/", "Commit the requirement, not the value."],
  ["/guides/env-files-are-not-secret-management/", "The file becomes a distribution system."],
  ["/guides/runtime-configuration-without-env-files/", "Start with the interface the receiving program expects."],
